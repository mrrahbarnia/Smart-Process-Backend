...
Revision ID: ae067c885245
Revises: 
Create Date: 2024-09-23 11:15:03.801571
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['attribute_id'], ['attributes.id'], name=op.f('fk_categoryattributes_attribute_id_attributes'), ondelete='CASCADE'),
    ...
    sa.PrimaryKeyConstraint('category_id', 'attribute_id', name=op.f('pk_categoryattributes'))
    )
    op.create_index(op.f('ix_categoryattributes_attribute_id'), 'categoryattributes', ['attribute_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['attribute_id'], ['attributes.id'], name=op.f('fk_attributevalues_attribute_id_attributes'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], name=op.f('fk_attributevalues_product_id_products'), ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_attributevalues'))
    )
    op.create_index(op.f('ix_attributevalues_attribute_id'), 'attributevalues', ['attribute_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_attributevalues_attribute_id'), table_name='attributevalues')
    ...
    op.drop_index(op.f('ix_categoryattributes_attribute_id'), table_name='categoryattributes')
